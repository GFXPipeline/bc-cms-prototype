...
export default class OnThisPageUI extends Plugin {
  init() {
    console.log("OnThisPageUI#init() got called");
    ...
    editor.ui.componentFactory.add("onThisPage", (locale) => {
      ...
      const command = editor.commands.get("insertOnThisPage");
      ...
      this.listenTo(buttonView, "execute", () => {
        editor.execute("insertOnThisPage");
      });
